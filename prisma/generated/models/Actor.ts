...
export type ActorOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "author" | "createdAt" | "updatedAt", ExtArgs["result"]["actor"]>
...
export interface ActorFieldRefs {
  ...
  readonly author: Prisma.FieldRef<"Actor", 'String'>
  readonly createdAt: Prisma.FieldRef<"Actor", 'String'>
  readonly updatedAt: Prisma.FieldRef<"Actor", 'String'>
}
